...
#define DEF_SAMPLING_DOWN_FACTOR	(6)
...
#define INPUT_EVENT_TIMEOUT	(250)
...
static int input_event_min_freq_array[NR_CPUS] = {1574400, 960000, 960000, 960000} ;
