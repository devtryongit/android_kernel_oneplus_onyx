...
echo "[Rudolph] Kicking-off post-boot script" | tee /dev/kmsg

############################
# RQ Stats
#
sleep 0.5
echo "[Rudolph] Disabling built-in RQ hotplug mechanism" | tee /dev/kmsg
...
sleep 0.5
# MSM Hotplug:
echo "[Rudolph] Enabling MSM hotplug driver" | tee /dev/kmsg
...
#
# Ondemand:
echo "[Rudolph] Tuning ondemand governor" | tee /dev/kmsg
...
# Interactive:
echo "[Rudolph] Tuning interactive governor" | tee /dev/kmsg
...
echo "[Rudolph] Tuning impulse governor" | tee /dev/kmsg
...
#
sleep 0.25
echo "[Rudolph] Disabling buggy notify on migrate" | tee /dev/kmsg
...
#
sleep 0.5
echo "[Rudolph] Initializing MSM limiter" | tee /dev/kmsg
...
#
sleep 0.5
echo "[Rudolph] Burning CPU input boost values" | tee /dev/kmsg
echo "1190400 1497600" > /sys/kernel/cpu_input_boost/ib_freqs
echo "1400" > /sys/kernel/cpu_input_boost/ib_duration_ms
echo "[Rudolph] Enabling CPU input boost driver" | tee /dev/kmsg
...
#
sleep 0.55
echo "[Rudolph] Tweaking CPU BW monitor governor" | tee /dev/kmsg
...
#
sleep 0.25
echo "[Rudolph] Setting zen as default scheduler" | tee /dev/kmsg
echo "zen" > /sys/block/mmcblk0/queue/scheduler
setprop sys.io.scheduler "zen"
echo "[Rudolph] Setting 1024kB as read ahead" | tee /dev/kmsg
...
#
sleep 0.25
echo "[Rudolph] Tweaking adreno idler parameters" | tee /dev/kmsg
...
echo "[Rudolph] Disabling adreno idler driver" | tee /dev/kmsg
...
#
sleep 0.25
echo "[Rudolph] Tweaking simple gpu algorithm parameters" | tee /dev/kmsg
...
echo "[Rudolph] Enabling simple gpu algorithm driver" | tee /dev/kmsg
...
#
sleep 0.25
echo "[Rudolph] Optimizing random wakeup thresholds" | tee /dev/kmsg
...
#
sleep 0.5
echo "[Rudolph] Optimizing virtual machine values" | tee /dev/kmsg
...
#
sleep 0.25
echo "[Rudolph] Empowering process reclaim" | tee /dev/kmsg
...
#
sleep 0.25
echo "[Rudolph] Setting custom LMK values" | tee /dev/kmsg
...
#
sleep 0.25
echo "[Rudolph] Disabling USB keyboard support" | tee /dev/kmsg
...
#
sleep 0.25
echo "[Rudolph] Enabling modem data suspend" | tee /dev/kmsg
...
#
sleep 0.25
echo "[Rudolph] Disabling debug masks" | tee /dev/kmsg
...
# Done!
#
echo "[Rudolph] Exiting post-boot script" | tee /dev/kmsg
